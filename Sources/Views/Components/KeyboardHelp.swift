...
struct KeyboardHelp: View {
    ...
    private let shortcuts: [Shortcut] = [
        ...
        Shortcut(key: "4", modifiers: "⌘", description: "Notes"),
        Shortcut(key: "5", modifiers: "⌘", description: "Tasks"),
        Shortcut(key: "6", modifiers: "⌘", description: "Timeline"),
        Shortcut(key: "7", modifiers: "⌘", description: "People"),
        Shortcut(key: "8", modifiers: "⌘", description: "Sources"),
